...
import com.example.catalogo_microservicios.domains.entities.dtos.CategoryDTO;
...
public class CategoryResource {
    ...
    public ResponseEntity<Object> create(@Valid @RequestBody CategoryDTO category) throws DuplicatedKeyException, InvalidDataException {
