...
import { NIFNIEValidator, TypeValidator, UppercaseValidator } from '../../../lib/my-core/directives/validadores.directive';
...
@Component({
  ...
  imports: [FormsModule, ErrorMessagePipe, NIFNIEValidator, TypeValidator, UppercaseValidator, JsonPipe, FormButtonsComponent, ErrorMessagePipe],
